...
function makeGunClock(hour, minute, second){
...
function GunClock(hour,minute, second){

	initGunClock();
	makeGunClock(hour, minute, second);
//	gunman.display(20,5);
...
// newline = "\n\r" , "<br />", ...
exports.getGunClock = function(size, newline, hour, minute, second){
    strNewline = newline;
    clockSize = size;
    return GunClock(hour, minute, second);
}
